          ...
          <Row2>
            <Col>
              <InputForm
                disabled={disabled}
                name="강사 번호"
                value={this.state.teacher.tel}
                onChange={(e) => this._handleTeacherEdit("tel", e.target.value)}/>
            </Col>
            <Col>
              <InputForm
                disabled={disabled}
                name="강사 번호2"
                value={this.state.teacher.ptel}
                onChange={(e) => this._handleTeacherEdit("ptel", e.target.value)}/>
            </Col>
          </Row2>
          <Row2>
            <Col>
